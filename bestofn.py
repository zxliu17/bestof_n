...
agent_number =200
N=1
figurename = str(agent_number)+'_'+str(iter)+'_'+str(N)
...
def iteration(agents,agent_number, iteration_times):
    ...
    while iteration < N:
        ...
        # print (iteration)
        index1 = bnfc.pick_agent(agents,reward)
        index2 = bnfc.pick_agent(agents,reward)
        #t = agents [index1]
        #s = agents [index2]
